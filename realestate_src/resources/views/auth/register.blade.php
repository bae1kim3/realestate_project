                ...
                <div class="col-lg-9 text-center mt-5">
                    ...
                    <nav aria-label="breadcrumb" data-aos="fade-up" data-aos-delay="200">
                        <ol class="breadcrumb text-center justify-content-center">
                            <button class="btn btn-primary py-1 px-2"><li id="use" style="font-size: 20px; font-weight: bolder;">일반회원</li></button>
                            <p style="color:white; margin:0px 10px; font-size:20px"> / </p>
                            <button class="btn btn-primary py-1 px-2"><li id="sell" style="font-size: 20px; font-weight: bolder;">
                                공인중개사
                            </li></button>
                        </ol>
                    </nav>
            ...
            <div class="row text-left mb-5">
                ...
                <div id="show">
                    ...
                    <a href="{{ route('user-register') }}" id="registerButton"
                        style="display: none;"><button class="btn btn-primary py-2 px-3">회원가입</button></a>
                </div>
            </div>
        </div>
    </div>
