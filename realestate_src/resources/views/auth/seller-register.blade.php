    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="u_id" class="block mt-1 w-full dark:bg-gray-700 dark:text-white" type="text" name="u_id" :value="old('u_id')" required autocomplete="u_id" />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="phone_no" class="block mt-1 w-full dark:bg-gray-700 dark:text-white" type="tel" name="phone_no" :value="old('phone_no')" required autocomplete="phone_no" />
            </div>

            <div class="mt-4">
                <x-label for="u_addr" value="{{ __('Address') }}" class="dark:text-white"/>
                <x-input id="u_addr" class="block mt-1 w-full dark:bg-gray-700 dark:text-white" type="text" name="u_addr" :value="old('u_addr')" required autocomplete="u_addr" />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="seller_license" class="block mt-1 w-full dark:bg-gray-700 dark:text-white" type="text" name="seller_license" :value="old('seller_license')" required autocomplete="seller_license" />
            </div>

            <div class="mt-4" id="check">
            <p style="color:red">라이센스 번호 확인</p>
            <x-button type="button" id="check_button" value="라이센스 확인" onclick="checkli();" class="dark:bg-gray-600">라이센스 확인</x-button>
            </div>

            <div class="mt-4">
                <x-label for="b_name" value="{{ __('Brand_Name') }}" class="dark:text-white"/>
                <x-input id="b_name" class="block mt-1 w-full dark:bg-gray-700 dark:text-white" type="text" name="b_name" :value="old('b_name')" required autocomplete="b_name" />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="pw_answer" class="block mt-1 w-full dark:bg-gray-700 dark:text-white" type="text" name="pw_answer" :value="old('pw_answer')" required autocomplete="pw_answer" />
            </div>
