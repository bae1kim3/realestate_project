        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-9 text-center mt-5">
                    <h1 class="heading" data-aos="fade-up">공인중개사 가입</h1>
                ...
                <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <x-input id="seller_license" class="form-control" type="text" name="seller_license" :value="old('seller_license')" required autocomplete="seller_license" />
                        </div>
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <x-input id="b_name" class="form-control" type="text" name="b_name" :value="old('b_name')" required autocomplete="b_name" />
                            <span id="b_name-error" class="error-message" style="color: rgb(250, 73, 73);"></span>
                        </div>
