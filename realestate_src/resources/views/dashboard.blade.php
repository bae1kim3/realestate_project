...
<x-slot name="logo">
    ...
    <div class="wrap">
        ...
        @endif
                ...
                <div class="p-10 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-700 dark:border-gray-700" style="padding:40px">
                        ...
                        <div class="row">
                            <div class="col-md-4 offset-md-4">
                                <form action="{{ route('struct.insert.post') }}" id="frm" method="POST" enctype="multipart/form-data">
                                    ...
                                    <x-input type="text" name="s_size" id="s_size" required maxlength="11" value="{{old('s_size')}}" class="mt-2 dark:bg-gray-600 dark:text-white"/><span class="dark:text-white">평</span>
                                    <br>
                                    ...
                                    <x-input type="text" name="sub_name" maxlength="11" id="sub_name" required value="{{old('sub_name')}}" class="mt-2 dark:text-white dark:bg-gray-600"/><span class="dark:text-white">역</span>
                                    ...
                                    <x-input type="text" name="p_deposit" id="p_deposit" class="mt-2 dark:bg-gray-600" required value="{{old('p_deposit')}}" maxlength="11"/><span class="dark:text-white">만원</span><br>
                                    <x-label for="p_month" class="mt-5 font-semibold text-xl dark:text-white">월세</x-label>
                                    <x-input type="text" name="p_month" id="p_month" class="mt-2 dark:bg-gray-600" value="{{old('p_month')}}" maxlength="11"/><span class="dark:text-white">만원</span>
                                    <br>
                                    <x-label for="s_fl" class="mt-5 font-semibold text-xl dark:text-white">층수</x-label>
                                    <x-input type="text" name="s_fl" id="s_fl" class="mt-2 dark:bg-gray-600" required value="{{old('s_fl')}}" maxlength="3" style="margin-bottom:40px"/><span class="dark:text-white">층</span>
                                    <hr><br><br>
